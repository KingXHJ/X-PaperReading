本文来自于：[设计模式也可以这么简单](https://javadoop.com/post/design-pattern)

# 设计模式也可以这么简单

[](https://javadoop.com/post/download?userName=hongjie&postName=design-pattern)

创建时间: 2022-12-04 19:22:03
